    ...
    <div className="flex flex-col min-h-screen">
      <header className="bg-primary text-primary-foreground py-8 shadow-sm">
        <div className="container flex items-center justify-between">
          ...
          <Link href='/login'>
          <Button className=" px-6 mx-8 py-3 rounded-md bg-primary-foreground text-primary hover:bg-primary-foreground/90 transition-colors animate-fade-in-up delay-100">
            Signin
          </Button>
      </Link>
        </div>
